...
import ru.alekseiovechkin.votesystem.util.ValidationUtil;
import ru.alekseiovechkin.votesystem.util.exception.ErrorInfo;
import ru.alekseiovechkin.votesystem.util.exception.ErrorType;
...
import static ru.alekseiovechkin.votesystem.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo beanValidationExceptionHandler(HttpServletRequest req, BindException e) {
        List<String> errors = ValidationUtil.getErrorsFieldList(e.getFieldErrors());
    ...
    public ErrorInfo argumentNotValidHandler(HttpServletRequest req, MethodArgumentNotValidException e) {
        List<String> errors = ValidationUtil.getErrorsFieldList(e.getBindingResult().getFieldErrors());
        return warnAndGetErrorInfo(req.getRequestURL(), VALIDATION_ERROR, errors);
    }
